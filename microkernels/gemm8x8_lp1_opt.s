...
ic_loop:
    ...
    fmla    v16.4s, v12.4s, v3.s[0]      // out-1l: w2*inp2
    fmla    v17.4s, v13.4s, v3.s[0]      // out-1h: w2*inp2
    fmla    v19.4s, v13.4s, v4.s[0]      // out-2h: w2*inp3
    fmla    v18.4s, v12.4s, v4.s[0]      // out-2l: w2*inp3
    fmla    v20.4s, v12.4s, v5.s[0]      // out-3l: w2*inp4
    fmla    v21.4s, v13.4s, v5.s[0]      // out-3h: w2*inp4
    fmla    v23.4s, v13.4s, v6.s[0]      // out-4h: w2*inp5
    fmla    v22.4s, v12.4s, v6.s[0]      // out-4l: w2*inp5
    fmla    v24.4s, v12.4s, v7.s[0]      // out-5l: w2*inp6
    fmla    v25.4s, v13.4s, v7.s[0]      // out-5h: w2*inp6
    fmla    v27.4s, v13.4s, v8.s[0]      // out-6h: w2*inp7
    fmla    v26.4s, v12.4s, v8.s[0]      // out-6l: w2*inp7
    fmla    v28.4s, v12.4s, v9.s[0]      // out-7l: w2*inp8
    fmla    v29.4s, v13.4s, v9.s[0]      // out-7h: w2*inp8
    fmla    v31.4s, v13.4s, v10.s[0]     // out-8h: w2*inp9
    fmla    v30.4s, v12.4s, v10.s[0]     // out-8l: w2*inp9

    ld1     {v0.4s, v1.4s}, [x19], #32  // w3
    ld1     {v12.4s, v13.4s}, [x17], #32  // w1
    ...
    fmla    v16.4s, v12.4s, v2.s[1]      // out-1l: w1*inp1
    fmla    v17.4s, v13.4s, v2.s[1]      // out-1h: w1*inp1
    fmla    v19.4s, v13.4s, v3.s[1]      // out-2h: w1*inp2
    fmla    v18.4s, v12.4s, v3.s[1]      // out-2l: w1*inp2
    fmla    v20.4s, v12.4s, v4.s[1]      // out-3l: w1*inp3
    fmla    v21.4s, v13.4s, v4.s[1]      // out-3h: w1*inp3
    fmla    v23.4s, v13.4s, v5.s[1]      // out-4h: w1*inp4
    fmla    v22.4s, v12.4s, v5.s[1]      // out-4l: w1*inp4
    fmla    v24.4s, v12.4s, v6.s[1]      // out-5l: w1*inp5
    fmla    v25.4s, v13.4s, v6.s[1]      // out-5h: w1*inp5
    fmla    v27.4s, v13.4s, v7.s[1]      // out-6h: w1*inp6
    fmla    v26.4s, v12.4s, v7.s[1]      // out-6l: w1*inp6
    fmla    v28.4s, v12.4s, v8.s[1]      // out-7l: w1*inp7
    fmla    v29.4s, v13.4s, v8.s[1]      // out-7h: w1*inp7
    fmla    v31.4s, v13.4s, v9.s[1]      // out-8h: w1*inp8
    fmla    v30.4s, v12.4s, v9.s[1]      // out-8l: w1*inp8

    ld1     {v0.4s, v1.4s}, [x18], #32  // w2
    ld1     {v12.4s, v13.4s}, [x19], #32  // w3
    ...
    fmla    v16.4s, v12.4s, v4.s[1]      // out-1l: w3*inp3
    fmla    v17.4s, v13.4s, v4.s[1]      // out-1h: w3*inp3
    fmla    v19.4s, v13.4s, v5.s[1]      // out-2h: w3*inp4
    fmla    v18.4s, v12.4s, v5.s[1]      // out-2l: w3*inp4
    fmla    v20.4s, v12.4s, v6.s[1]      // out-3l: w3*inp5
    fmla    v21.4s, v13.4s, v6.s[1]      // out-3h: w3*inp5
    fmla    v23.4s, v13.4s, v7.s[1]      // out-4h: w3*inp6
    fmla    v22.4s, v12.4s, v7.s[1]      // out-4l: w3*inp6
    fmla    v24.4s, v12.4s, v8.s[1]      // out-5l: w3*inp7
    fmla    v25.4s, v13.4s, v8.s[1]      // out-5h: w3*inp7
    fmla    v27.4s, v13.4s, v9.s[1]      // out-6h: w3*inp8
    fmla    v26.4s, v12.4s, v9.s[1]      // out-6l: w3*inp8
    fmla    v28.4s, v12.4s, v10.s[1]     // out-7l: w3*inp9
    fmla    v29.4s, v13.4s, v10.s[1]     // out-7h: w3*inp9
    fmla    v31.4s, v13.4s, v11.s[1]     // out-8h: w3*inp10
    fmla    v30.4s, v12.4s, v11.s[1]     // out-8l: w3*inp10
    ...
    fmla    v16.4s, v12.4s, v3.s[2]      // out-1l: w2*inp2
    fmla    v17.4s, v13.4s, v3.s[2]      // out-1h: w2*inp2
    fmla    v19.4s, v13.4s, v4.s[2]      // out-2h: w2*inp3
    fmla    v18.4s, v12.4s, v4.s[2]      // out-2l: w2*inp3
    fmla    v20.4s, v12.4s, v5.s[2]      // out-3l: w2*inp4
    fmla    v21.4s, v13.4s, v5.s[2]      // out-3h: w2*inp4
    fmla    v23.4s, v13.4s, v6.s[2]      // out-4h: w2*inp5
    fmla    v22.4s, v12.4s, v6.s[2]      // out-4l: w2*inp5
    fmla    v24.4s, v12.4s, v7.s[2]      // out-5l: w2*inp6
    fmla    v25.4s, v13.4s, v7.s[2]      // out-5h: w2*inp6
    fmla    v27.4s, v13.4s, v8.s[2]      // out-6h: w2*inp7
    fmla    v26.4s, v12.4s, v8.s[2]      // out-6l: w2*inp7
    fmla    v28.4s, v12.4s, v9.s[2]      // out-7l: w2*inp8
    fmla    v29.4s, v13.4s, v9.s[2]      // out-7h: w2*inp8
    fmla    v31.4s, v13.4s, v10.s[2]     // out-8h: w2*inp9
    fmla    v30.4s, v12.4s, v10.s[2]     // out-8l: w2*inp9
    ...
    fmla    v16.4s, v12.4s, v2.s[3]      // out-1l: w1*inp1
    fmla    v17.4s, v13.4s, v2.s[3]      // out-1h: w1*inp1
    fmla    v19.4s, v13.4s, v3.s[3]      // out-2h: w1*inp2
    fmla    v18.4s, v12.4s, v3.s[3]      // out-2l: w1*inp2
    fmla    v20.4s, v12.4s, v4.s[3]      // out-3l: w1*inp3
    fmla    v21.4s, v13.4s, v4.s[3]      // out-3h: w1*inp3
    fmla    v23.4s, v13.4s, v5.s[3]      // out-4h: w1*inp4
    fmla    v22.4s, v12.4s, v5.s[3]      // out-4l: w1*inp4
    fmla    v24.4s, v12.4s, v6.s[3]      // out-5l: w1*inp5
    fmla    v25.4s, v13.4s, v6.s[3]      // out-5h: w1*inp5
    fmla    v27.4s, v13.4s, v7.s[3]      // out-6h: w1*inp6
    fmla    v26.4s, v12.4s, v7.s[3]      // out-6l: w1*inp6
    fmla    v28.4s, v12.4s, v8.s[3]      // out-7l: w1*inp7
    fmla    v29.4s, v13.4s, v8.s[3]      // out-7h: w1*inp7
    fmla    v31.4s, v13.4s, v9.s[3]      // out-8h: w1*inp8
    fmla    v30.4s, v12.4s, v9.s[3]      // out-8l: w1*inp8
    ...
    fmla    v16.4s, v12.4s, v4.s[3]      // out-1l: w3*inp3
    fmla    v17.4s, v13.4s, v4.s[3]      // out-1h: w3*inp3
    fmla    v19.4s, v13.4s, v5.s[3]      // out-2h: w3*inp4
    fmla    v18.4s, v12.4s, v5.s[3]      // out-2l: w3*inp4
    fmla    v20.4s, v12.4s, v6.s[3]      // out-3l: w3*inp5
    fmla    v21.4s, v13.4s, v6.s[3]      // out-3h: w3*inp5
    fmla    v23.4s, v13.4s, v7.s[3]      // out-4h: w3*inp6
    fmla    v22.4s, v12.4s, v7.s[3]      // out-4l: w3*inp6
    fmla    v24.4s, v12.4s, v8.s[3]      // out-5l: w3*inp7
    fmla    v25.4s, v13.4s, v8.s[3]      // out-5h: w3*inp7
    fmla    v27.4s, v13.4s, v9.s[3]      // out-6h: w3*inp8
    fmla    v26.4s, v12.4s, v9.s[3]      // out-6l: w3*inp8
    fmla    v28.4s, v12.4s, v10.s[3]     // out-7l: w3*inp9
    fmla    v29.4s, v13.4s, v10.s[3]     // out-7h: w3*inp9
    fmla    v31.4s, v13.4s, v11.s[3]     // out-8h: w3*inp10
    fmla    v30.4s, v12.4s, v11.s[3]     // out-8l: w3*inp10
