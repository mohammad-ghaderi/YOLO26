...
ic_loop:
    ...
    ld1         {v10.4s, v11.4s}, [x13], #32

    //                                      input: v0, v1, v2, v3, v8, v9, v10 ,v11
    ...
    fmla        v25.4s, v5.4s, v8.s[0]
    fmla        v26.4s, v6.4s, v8.s[0]
    fmla        v27.4s, v7.4s, v8.s[0]
    ...
    fmla        v24.4s, v4.4s, v8.s[1]
    fmla        v25.4s, v5.4s, v8.s[1]
    fmla        v26.4s, v6.4s, v8.s[1]
    fmla        v27.4s, v7.4s, v8.s[1]
    fmla        v28.4s, v4.4s, v10.s[1]
    fmla        v29.4s, v5.4s, v10.s[1]
    fmla        v30.4s, v6.4s, v10.s[1]
    fmla        v31.4s, v7.4s, v10.s[1]
    ...
    fmla        v24.4s, v4.4s, v8.s[2]
    fmla        v25.4s, v5.4s, v8.s[2]
    fmla        v26.4s, v6.4s, v8.s[2]
    fmla        v27.4s, v7.4s, v8.s[2]
    fmla        v28.4s, v4.4s, v10.s[2]
    fmla        v29.4s, v5.4s, v10.s[2]
    fmla        v30.4s, v6.4s, v10.s[2]
    fmla        v31.4s, v7.4s, v10.s[2]
    ...
    fmla        v24.4s, v4.4s, v8.s[3]
    fmla        v25.4s, v5.4s, v8.s[3]
    fmla        v26.4s, v6.4s, v8.s[3]
    fmla        v27.4s, v7.4s, v8.s[3]
    fmla        v28.4s, v4.4s, v10.s[3]
    fmla        v29.4s, v5.4s, v10.s[3]
    fmla        v30.4s, v6.4s, v10.s[3]
    fmla        v31.4s, v7.4s, v10.s[3]
    ...
    fmla        v24.4s, v4.4s, v9.s[0]
    fmla        v25.4s, v5.4s, v9.s[0]
    fmla        v26.4s, v6.4s, v9.s[0]
    fmla        v27.4s, v7.4s, v9.s[0]
    ...
    fmla        v20.4s, v4.4s, v3.s[1]
    fmla        v21.4s, v5.4s, v3.s[1]
    fmla        v22.4s, v6.4s, v3.s[1]
    fmla        v23.4s, v7.4s, v3.s[1]
    fmla        v24.4s, v4.4s, v9.s[1]
    fmla        v25.4s, v5.4s, v9.s[1]
    fmla        v26.4s, v6.4s, v9.s[1]
    fmla        v27.4s, v7.4s, v9.s[1]
    ...
    fmla        v24.4s, v4.4s, v9.s[2]
    fmla        v25.4s, v5.4s, v9.s[2]
    fmla        v26.4s, v6.4s, v9.s[2]
    ...
    fmla        v21.4s, v5.4s, v3.s[3]
    fmla        v22.4s, v6.4s, v3.s[3]
    fmla        v23.4s, v7.4s, v3.s[3]
    fmla        v24.4s, v4.4s, v9.s[3]
    fmla        v25.4s, v5.4s, v9.s[3]
    fmla        v26.4s, v6.4s, v9.s[3]
    fmla        v27.4s, v7.4s, v9.s[3]
